...
switch ($action) {
    ...
    case "update_assignment":
        ...
        {
            update_assignment(assignment_id: $assignment_id, description: $description, course_id: $course_id);
            //Refreshes the page and displays the updated assignment
            header("Location: .?action=list_assignments&course_id=" . $course_id);
            exit();
        } else {
            $error = "Invalid assignment data. Please check all fields and try again.";
            include('view/error.php');
            exit();
        }
        break;
    case "update_course":
        error_log("Received course_id: $course_id, course_name: $course_name");
        if($course_id && !empty($course_name))
        {
            ...
            $error = "Invalid course data. Please check all fields and try again.";
            include('view/error.php');
            exit();
        }
        break;
